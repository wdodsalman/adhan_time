...
import '../model/azkar_model/azkar_after_salah/content.dart';


class AzkarsalahUi extends StatelessWidget {
  const AzkarsalahUi({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AdhanTimeBloc()..add(GetAzkarsalah()),
                ...
                child: Directionality(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) => Azkarsalahcard(
                            contect: state.azkarsalah?.content?[index] ??
                                Contentsalah(
...
class Azkarsalahcard extends StatelessWidget {
  Azkarsalahcard({Key? key, this.contect}) : super(key: key);
  Contentsalah? contect;
  @override
  Widget build(BuildContext context) {
    return Container(
